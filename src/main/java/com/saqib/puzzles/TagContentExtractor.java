 ...
 * corresponding end tag starts with a /. Given a string of text in a tag-based
 * language, parse this text and retrieve the contents enclosed within sequences
 * of well-organized tags meeting the following criterion: The name of the start
 * and end tags must be same. The HTML code
 ...
 * Input Format
 * 
 * The first line of input contains a single integer, (the number of lines). The
 ...
 * Output Format
 * 
 * For each line, print the content enclosed within valid tags. If a line
 * contains multiple instances of valid content, print out each instance of
